...
const form = useForm({
    ...
    discount_amount: props.promoCode.discount_amount,
    max_discount_amount: props.promoCode.max_discount_amount || 0,
    min_purchase_amount: props.promoCode.min_purchase_amount,
    start_date: props.promoCode.start_date
        ? props.promoCode.start_date.substring(0, 16)
        : "",
    end_date: props.promoCode.end_date
        ? props.promoCode.end_date.substring(0, 16)
        : "",
    usage_limit: props.promoCode.usage_limit || "",
    is_active: Boolean(props.promoCode.is_active),
});
...
<template>
    ...
    <AdminLayout title="Edit Kode Promo">
        <div class="mb-8">
            <Link
