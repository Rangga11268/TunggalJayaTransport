<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Create Weekly Schedule Template') }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-bold">Create New Weekly Schedule Template</h3>
                        <a href="{{ route('admin.weekly-schedule-templates.index') }}" class="text-blue-500 hover:text-blue-700">
                            ← Back to Templates
                        </a>
                    </div>
                    
                    <form method="POST" action="{{ route('admin.weekly-schedule-templates.store') }}">
                        @csrf
