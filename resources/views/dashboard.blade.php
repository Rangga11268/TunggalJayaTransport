            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <a href="#" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-4 px-6 rounded text-center">
                            Create Booking
                        </a>
                        <a href="#" class="bg-green-500 hover:bg-green-600 text-white font-bold py-4 px-6 rounded text-center">
                            Add News
                        </a>
                        <a href="#" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-4 px-6 rounded text-center">
                            Manage Routes
                        </a>
                        <a href="#" class="bg-purple-500 hover:bg-purple-600 text-white font-bold py-4 px-6 rounded text-center">
                            View Reports
                        </a>
                    </div>
                </div>
