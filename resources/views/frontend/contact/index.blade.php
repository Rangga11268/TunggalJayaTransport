...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 page-spacing">
    ...
    <div class="text-center mb-12">
        ...
        <p class="text-xl text-gray-600 max-w-3xl mx-auto">Have questions or need assistance? Our team is here to help you with any inquiries about our services</p>
    </div>
        ...
        <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl shadow-lg p-8">
            ...
            <form method="POST" action="{{ route('frontend.contact.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 py-3 px-4">
                    @error('email')
                        <p class="mt-1 text-sm text-red-600"><i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                    @enderror
                </div>
