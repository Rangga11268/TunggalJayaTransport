    ...
    @elseif($hoursUntilDeparture >= 0 && $hoursUntilDeparture <= 24)
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                saveSeatsButton.disabled = selectedSeats.length !== {
                    {
                ...
                function showStepTimeEstimates() {
                    ...
                    const stepTimes = {
                        schedule: {
                            time: '< 1 min',
                            desc: 'Select your preferred schedule'
                        },
                        passenger: {
                            time: '< 1 min',
                        ...
                        seat: {
                            time: '1-2 min',
                            desc: 'Choose your preferred seat'
                        },
                        payment: {
                            time: '< 1 min',
                            desc: 'Complete your payment'
                        }
                    };
