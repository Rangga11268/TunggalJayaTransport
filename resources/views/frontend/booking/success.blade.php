...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 page-spacing">
    ...
    <div class="bg-white rounded-xl shadow-md p-4 sm:p-8 mb-6 sm:mb-8 text-left mobile-info-card">
            ...
            <div class="bg-gray-50 p-4 sm:p-5 rounded-lg mobile-info-card">
                ...
                <div class="space-y-3">
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="text-xs sm:text-sm text-gray-500">Kode Pemesanan</p>
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            <p class="text-xs sm:text-sm text-gray-500">Keberangkatan</p>
                            <p class="font-medium text-sm sm:text-base">
                ...
                <div class="space-y-3">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="text-xs sm:text-sm text-gray-500">Nomor Kursi</p>
        ...
        <div
            ...
            <div class="text-center sm:text-left">
                <p class="text-gray-600 text-sm sm:text-base mb-2">Status Pembayaran:
                    ...
                    <button onclick="checkPaymentStatus('{{ $booking->midtrans_transaction_id }}')"
                        class="ml-2 text-xs bg-blue-100 text-blue-600 px-2 py-1 rounded hover:bg-blue-200 transition-colors">
    ...
    <script>
        function checkPaymentStatus(orderId) {
            ...
            fetch(`/booking/payment/status/${orderId}`)
                ...
                .then(data => {
                    if (data.status === 'success') {
                        ...
                        Swal.fire({
                            ...
                            text: 'Status pembayaran masih pending. Silakan coba lagi nanti.',
                            confirmButtonColor: '#3b82f6'
                        });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Auto-refresh happens in the controller, but we can show a loading indicator
            console.log('Payment status checked automatically');
            @endif
        });
    </script>
    @endpush
