...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 page-spacing">
    <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl shadow-lg p-8 mb-10 text-center mobile-booking-card">
        ...
        <div class="bg-white rounded-xl shadow-md p-8 mb-8 text-left mobile-info-card">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="bg-gray-50 p-5 rounded-lg mobile-info-card">
                    <h3 class="text-lg font-medium mb-4 text-gray-800 border-b border-gray-200 pb-2 mobile-info-card-title">Trip Information</h3>
                    <div class="space-y-3">
        ...
        <!-- Ticket Preview -->
        <div class="bg-white rounded-xl shadow-md p-6 mb-8 mobile-info-card">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4 mt-8 mobile-button-group">
            <a href="{{ route('frontend.booking.view-ticket', $booking->id) }}" 
               class="bg-gradient-to-r from-green-600 to-emerald-700 hover:from-green-700 hover:to-emerald-800 text-white font-bold py-3 px-6 rounded-lg transition duration-300 shadow-lg transform hover:scale-105 flex items-center justify-center mobile-action-button"
               target="_blank">
                <i class="fas fa-eye mr-2"></i> View Ticket
            </a>
            <a href="{{ route('frontend.booking.download-ticket', $booking->id) }}" 
               class="bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white font-bold py-3 px-6 rounded-lg transition duration-300 shadow-lg transform hover:scale-105 flex items-center justify-center mobile-action-button">
                <i class="fas fa-download mr-2"></i> Download Ticket (PDF)
            </a>
            <a href="{{ route('frontend.booking.index') }}" 
               class="bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-white font-bold py-3 px-6 rounded-lg transition duration-300 shadow-lg transform hover:scale-105 flex items-center justify-center mobile-action-button">
                <i class="fas fa-bus mr-2"></i> Book Another Ticket
            </a>
            <a href="{{ route('frontend.home') }}" 
               class="bg-gradient-to-r from-purple-600 to-violet-700 hover:from-purple-700 hover:to-violet-800 text-white font-bold py-3 px-6 rounded-lg transition duration-300 shadow-lg transform hover:scale-105 flex items-center justify-center mobile-action-button">
    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl shadow-lg p-8 mb-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-white p-6 rounded-lg shadow-sm text-center mobile-info-card">
