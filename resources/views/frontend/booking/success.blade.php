                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="font-medium text-sm sm:text-base">{{ $booking->schedule->departure_time->format('l, F j, Y') }}</p>
                            </div>
                        </div>
                        <div class="flex items-center">
                            <div class="bg-green-100 p-2 rounded-full mr-3">
                            ...
                            <div>
                                ...
                                <p class="font-medium text-sm sm:text-base">{{ $booking->schedule->departure_time->format('H:i') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
