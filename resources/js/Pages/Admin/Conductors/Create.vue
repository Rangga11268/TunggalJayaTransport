...
const submit = () => {
    form.post(route("admin.conductors.store"), {
        preserveScroll: true,
        forceFormData: true,
    });
};
...
<template>
    <Head title="Tambah Kondektur" />

    <AdminLayout title="Tambah Kondektur">
        <div class="max-w-4xl mx-auto">
            <div class="flex items-center justify-between mb-8">
                <div>
                    ...
                    >
                        Tambah Kondektur Baru
                    </h2>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        Daftarkan kondektur baru untuk armada.
                    </p>
                </div>
                <Link
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                ></i>
                                <span v-else>Simpan Kondektur</span>
                            </button>
                        </div>
                    </div>
                </div>
