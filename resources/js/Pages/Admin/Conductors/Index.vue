...
<template>
    <Head title="Manajemen Kondektur" />

    <AdminLayout title="Manajemen Kondektur">
        <div
        ...
        >
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                    Kelola data kondektur armada bus.
                </p>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                >
                    ...
                    <span class="hidden md:inline">Tambah Kondektur</span>
                </Link>
            </div>
        </div>
        ...
        >
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    ...
                    >
                        <tr
                            v-for="conductor in conductors.data"
                            :key="conductor.id"
                        ...
                        >
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    >
                                        <img
                                            v-if="conductor.image_url"
                                            :src="conductor.image_url"
                                            alt="Foto Kondektur"
                        ...
                        <tr v-if="conductors.data.length === 0">
                            <td
                                colspan="5"
                            ...
                            >
                                <div class="flex flex-col items-center">
                                    <i
                                        class="fas fa-id-badge text-4xl mb-3 opacity-30"
                                    ></i>
                                    <p>Belum ada data kondektur.</p>
                                </div>
                            </td>
                        </tr>
                    </tbody>
            ...
            <div
                ...
                v-if="conductors.links.length > 3"
            >
                <div class="text-xs text-gray-500">
                    Menampilkan {{ conductors.from }} - {{ conductors.to }} dari
                    {{ conductors.total }} data
                </div>
                <div class="flex gap-1">
                    <template v-for="(link, k) in conductors.links" :key="k">
                        <Link
                            v-if="link.url"
                            :href="link.url"
                            v-html="link.label"
