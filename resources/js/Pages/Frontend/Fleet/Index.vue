...
<template>
    ...
    <!-- Hero Header -->
    <div class="relative bg-primary-950 py-32 overflow-hidden">
        <!-- Background Elements -->
        ...
        >
            ...
            <h1
                class="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6 font-serif animate-fade-in-up"
            >
                Armada
                <span
            ...
            <p
                class="text-lg text-slate-300 max-w-2xl mx-auto animate-fade-in-up stagger-1"
            >
