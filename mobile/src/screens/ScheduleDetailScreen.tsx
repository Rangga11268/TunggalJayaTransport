...
export default function ScheduleDetailScreen() {
  ...
  const [activeTab, setActiveTab] = useState<'deals' | 'details' | 'reviews'>('details');
  ...
  const busType = schedule?.bus?.bus_type || 'Executive Class';
  ...
  const getImageSource = () => {
    ...
    if (name.includes('bentas')) return require('../../assets/images/bentas01.webp');
    if (name.includes('kyloren')) return require('../../assets/images/kylorenParwis.webp');
    ...
    <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.routeHeaderOverlay}>
            <View style={styles.routeHeaderLeft}>
              ...
              <Text style={styles.routeHeaderSub}>{origin} ↔ {destination}</Text>
            </View>
            ...
            <View style={styles.routeHeaderRight}>
              ...
              <Text style={styles.routeHeaderPrice}>
                Rp {price} <Text style={styles.routeHeaderPriceSub}>/ Seat</Text>
              </Text>
            </View>
          </View>
        </LinearGradient>
      ...
      >
              ...
              <View style={styles.timelineWrapper}>
                <View style={styles.timelineItem}>
                  ...
                  <View style={styles.timelineInfo}>
                    ...
                    <Text style={styles.timelinePlace}>Pool Keberangkatan {origin}</Text>
                    <Text style={styles.timelineSub}>Check-in 30 menit sebelum keberangkatan</Text>
                  </View>
                </View>
                ...
                <View style={styles.timelineItem}>
                  ...
                  <View style={styles.timelineInfo}>
                    ...
                    <Text style={styles.timelinePlace}>Terminal Kedatangan {destination}</Text>
                    <Text style={styles.timelineSub}>Estimasi kedatangan tepat waktu</Text>
                  </View>
                </View>
              </View>
            </View>
            ...
            <View style={styles.card}>
              ...
              <View style={styles.facilitiesGrid}>
                <View style={styles.facilityRow}>
                  ...
                  <Text style={styles.facilityName}>Full AC Dual Blower Sejuk</Text>
                </View>
                <View style={styles.facilityRow}>
                  <CheckCircle size={16} color={COLORS.brandRed} />
                  <Text style={styles.facilityName}>Reclining Seat &amp; Sandaran Kaki (Leg Rest)</Text>
                </View>
                <View style={styles.facilityRow}>
                  <CheckCircle size={16} color={COLORS.brandRed} />
                  <Text style={styles.facilityName}>Colokan USB Fast Charger Tiap Kursi</Text>
                </View>
                <View style={styles.facilityRow}>
                  <CheckCircle size={16} color={COLORS.brandRed} />
                  <Text style={styles.facilityName}>Toilet Bersih Terawat di Dalam Kabin</Text>
                </View>
                <View style={styles.facilityRow}>
                  <CheckCircle size={16} color={COLORS.brandRed} />
                  <Text style={styles.facilityName}>Audio &amp; Karaoke Smart TV</Text>
                </View>
                <View style={styles.facilityRow}>
                  <CheckCircle size={16} color={COLORS.brandRed} />
                  <Text style={styles.facilityName}>Free Snack &amp; Air Mineral Botol</Text>
                </View>
              </View>
            </View>
            ...
            <View style={styles.card}>
              ...
              <View style={styles.crewRow}>
                ...
                <View style={styles.crewInfo}>
                  ...
                  <Text style={styles.crewSub}>Driver Utama Berlisensi Resmi &amp; Kondektur Ramah</Text>
                </View>
        ...
        {activeTab === 'deals' && (
          <View style={styles.sectionContainer}>
            <View style={styles.card}>
              <Text style={styles.cardTitle}>Penawaran &amp; Diskon Tersedia</Text>
              <View style={styles.dealItem}>
                ...
                <View style={styles.dealContent}>
                  ...
                  <Text style={styles.dealDesc}>Gunakan kode <Text style={{ color: COLORS.brandRed, fontFamily: 'PlusJakartaSans_700Bold' }}>TJBERKAH</Text> saat checkout.</Text>
                </View>
              </View>
              ...
              <View style={styles.dealItem}>
                ...
                <View style={styles.dealContent}>
                  ...
                  <Text style={styles.dealDesc}>Dapatkan 5.000 TJ Poin untuk member VIP setiap perjalanan.</Text>
                </View>
              </View>
            </View>
          </View>
        ...
        {activeTab === 'reviews' && (
          <View style={styles.sectionContainer}>
            <View style={styles.reviewsOverview}>
              ...
              <View>
                <Text style={styles.reviewScoreStars}>★★★★★</Text>
                <Text style={styles.reviewScoreCount}>Berdasarkan 9.600+ ulasan penumpang</Text>
              </View>
            </View>

            {[
              { name: 'Bambang Setyadi', stars: '★★★★★', date: '2 hari yang lalu', text: 'Unit Resi Bisma sangat bersih, AC dingin mantap, suspensi empuk banget tidak bikin mual!' },
              { name: 'Siti Rahmawati', stars: '★★★★★', date: '1 minggu yang lalu', text: 'Driver bawa busnya sangat aman dan tepat waktu sampai di Kuningan. Recomended!' },
              { name: 'Dwi Prasetyo', stars: '★★★★☆', date: '2 minggu yang lalu', text: 'Kursi leg rest luas dan colokan USB berfungsi dengan baik. Sangat puas.' },
            ].map((rev, i) => (
              <View key={i} style={styles.reviewCard}>
                ...
                <Text style={styles.reviewCardStars}>{rev.stars}</Text>
      ...
      <View style={styles.bottomBarWrapper} pointerEvents="box-none">
        <View style={styles.bottomBarContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              if (schedule?.id) {
                navigation.navigate('SeatSelection', { scheduleId: schedule.id });
              }
            }}
