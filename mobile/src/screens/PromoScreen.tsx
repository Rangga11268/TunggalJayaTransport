...
const PROMOS: PromoItem[] = [
  ...
  },
  {
    ...
    title: "Potongan Khusus Member",
    minSpend: "Tanpa Minimum",
    validUntil: "Selalu Aktif",
    terms: "Otomatis aktif untuk semua pengguna member",
  },
  {
    id: "4",
    category: "akap",
        ...
        >
          <View style={styles.heroBannerContent}>
            ...
            <Text style={styles.heroSubtitle}>
              Salin kode kupon di bawah dan gunakan saat memesan tiket bus atau
              sewa pariwisata.
            </Text>
          </View>
        </LinearGradient>
                ...
                <View style={styles.voucherBody}>
                  <View style={styles.voucherHeaderRow}>
                    <View style={styles.voucherBadgePill}>
                      <Text style={styles.voucherBadgePillText}>
                        {item.badge}
                      </Text>
                    </View>
